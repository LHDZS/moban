<template>
    <div class="Together">
        <div class="Cbody">
            ...
            <!-- 瀑布流 -->
            <div v-if="Commswitch == 0">
                <div>
                    <ul class="CommUl">
                        <li v-for="(item,index) in Commfenlei" :key="index" :class="CoRedIn==item.id ? 'Coomred' : ''" class="Coomli" @click="Commdianji(item.id)">{{item.name}}</li>
                        <div class="clear"></div>
                    </ul>
                </div>
                <div class="Commbaody">
                    <div class="Commhenglie" v-for="(item,key) in list" :key="key" v-if="key<shul">
                        <img class="Commhengimg" :src="https + item.thumb" alt="">
                        <div class="Commhengright">
                            <span class="Commhengname">{{item.name}}</span>
                            <div class="Coomhengjiage">
                                <span class="jiaf" :style="{color:color}">￥{{item.price}}</span>
                            </div>
                            <div class="Coomhenggoumai" :style="{backgroundColor:color}">热卖</div>
                        </div>
                    </div>
                </div>
            <div class="clear"></div>
        ...
        <div class="Commright">
            ...
            <div class="Swcaozuo" v-if="Comtype">
