...
const ENV_LIST = [
  {
    envName: 'test',
    dirName: 'test',
    apiHostname: 'http://www1.xiaoniren.cn',
    assetHostname: 'http://backend.xiaoniren.com.cn'
  },
  {
    envName: 'prod',
    dirName: 'prod',
    apiHostname: 'http://www.xiaoniren.cn',
    assetHostname:'http://backend.xiaoniren.cn'
  }
]
...
process.env.BACK_NAME = HOST_CONF.assetHostname
